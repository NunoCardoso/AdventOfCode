...
export default async (lineReader: any, params: Params) => {
  ...
  const getThemGeodes = (blueprint: Blueprint,
    ...
    oreRobot: number, clayRobot: number, obsidianRobot: number, geodeRobot: number,
