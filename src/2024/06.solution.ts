  ...
  const move = (
    ...
    while (true) {
      if (currentPosition[2] === '^')
        newPosition = [currentPosition[0] - 1, currentPosition[1], currentPosition[2]]
      if (currentPosition[2] === 'v')
        newPosition = [currentPosition[0] + 1, currentPosition[1], currentPosition[2]]
      if (currentPosition[2] === '>')
        newPosition = [currentPosition[0], currentPosition[1] + 1, currentPosition[2]]
      if (currentPosition[2] === '<')
        newPosition = [currentPosition[0], currentPosition[1] - 1, currentPosition[2]]
